"""
Django settings for ghsystems project.
...
LOCAL_APPS = [
    'ghsystems.apps.core',
    'ghsystems.apps.utils',
    'ghsystems.apps.tasks',
    'ghsystems.apps.api',
]
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'GH SYSTEMS API',
    'DESCRIPTION': 'GH Systems REST API',
    'VERSION': '1.0.0',
}

ROOT_URLCONF = 'ghsystems.urls'
...
WSGI_APPLICATION = 'ghsystems.wsgi.application'
